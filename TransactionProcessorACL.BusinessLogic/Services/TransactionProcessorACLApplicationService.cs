...
namespace TransactionProcessorACL.BusinessLogic.Services
{
    ...
    public class TransactionProcessorACLApplicationService : ITransactionProcessorACLApplicationService
    {
        ...
        public async Task<Result<MerchantResponse>> GetMerchant(Guid estateId,
            ...
            MerchantResponse merchantResponse = MerchantResponseFactory.Build(result.Data);

            return merchantResponse;
        }

        private static class MerchantResponseFactory
        {
            ...
            private static void PopulateMerchantContacts(List<TransactionProcessor.DataTransferObjects.Responses.Contract.ContactResponse> contacts,
                                                         MerchantResponse merchantResponse) {
                if (contacts == null) {
                    return;
                }
