...
@PRTest
Scenario: Merchant daily performance summary
	...
	| Today    | 8                 | Sale            | Test Merchant 1 | 123456780        | Test Estate 1 | Safaricom    | 50.00             | 123456789             |                      | Safaricom Contract  | Variable Topup |                |                 |

	When I get the merchant daily performance summary for Merchant "Test Merchant 1" for Estate "Test Estate 1"
...
Scenario: Merchant transaction mix summary
	...
	When I perform the following transactions
	| DateTime | TransactionNumber | TransactionType | MerchantName    | DeviceIdentifier | EstateName    | OperatorName | TransactionAmount | CustomerAccountNumber | CustomerEmailAddress | ContractDescription | ProductName    | RecipientEmail | RecipientMobile |
	| Today    | 9                 | Sale            | Test Merchant 1 | 123456780        | Test Estate 1 | Safaricom    | 25.00             | 123456789             |                      | Safaricom Contract  | Variable Topup |                |                 |
